...
I suppose you could always add more tickets and flip it back on. Or just leave it be — don't you have groceries to pick up?

You can route things from your personal list to a project with a `#project` tag in the item text, by the way. Whoops — forgot to mention that earlier, huh?
